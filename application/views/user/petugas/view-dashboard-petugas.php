<div class="container" style="color: #FE804D;">
	...
	<div class="text-center">
		<br>
		<h1 class="fw-bolder">Selamat Datang Petugas!</h1>
	</div>
			...
			<div class="col-4">
				<div class="card" style="background-color: #FE804D;">
					...
					<div class="card-body">
						...
						<div class="text-center">
							<a href="<?= base_url('petugas/jadwal')?>" class="btn btn-primary" style="background-color: white; color:#FE804D;">Lihat Jadwal</a>
						</div>
					</div>
				</div>
			</div>
