!(function (t, e) {
	...
	function et(t) {
		ze.isVisible() && it !== t.target.value && ze.resetValidationMessage(),
			(it = t.target.value);
	}
	function nt(t, e) {
	...
	function St(t, i) {
		...
		L(r), (r.innerHTML = "");
		var a = parseInt(
			null === i.currentProgressStep ? ze.getQueueStep() : i.currentProgressStep
		);
	...
	var $t = function (t, e, n, o) {
			(jt.swalCloseEventFinishedCallback = Yt.bind(null, t, n, ut(), o)),
	...
	function ie(t) {
		...
		"function" == typeof t.onBeforeOpen && t.onBeforeOpen(n),
			...
			ut() || jt.previousActiveElement || (jt.previousActiveElement = document.activeElement),
	...
	var pe = function (t, e) {
			pt && V(e)
				? ((t.style.overflowY = "hidden"), e.addEventListener(pt, oe.bind(null, e, t)))
		...
		Te = function () {
			var t = K(),
				e = Y();
			document.activeElement === t && I(e)
				? e.focus()
				: document.activeElement === e && I(t) && t.focus();
		},
		Le = function (t, e, n) {
		...
		qe = function (t, e) {
			if (!e.toast)
				return C(e.allowEnterKey)
					? e.focusCancel && I(t.cancelButton)
						? t.cancelButton.focus()
						: e.focusConfirm && I(t.confirmButton)
	...
	if (
		...
		var Fe = new Date(),
			_e = localStorage.getItem("swal-initiation");
		_e
			? 3 < (Fe.getTime() - Date.parse(_e)) / 864e5 &&
			  setTimeout(function () {
			...
			: localStorage.setItem("swal-initiation", "".concat(Fe));
	}
	s(Ue.prototype, Ne),
		s(Ue, Nt),
